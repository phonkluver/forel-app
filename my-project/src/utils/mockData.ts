  ...
  const data = {
    salads: [
      { id: "sal-01", names:{ru:"Цезарь с курицей",en:"Caesar with Chicken",zh:"凯撒沙拉配鸡肉"}, price:32,
        ...
        image:"/menuCezar-s-kuritsey.png", imageAltEn:"Caesar with Chicken salad served in a bowl with fresh vegetables and herbs" },
      { id: "sal-02", names:{ru:"Цезарь с форелью",en:"Caesar with Trout",zh:"凯撒沙拉配鳟鱼"}, price:45,
        ...
        image:"/menuCezar-s-foreliu.png", imageAltEn:"Caesar with Trout salad served in a bowl with fresh vegetables and herbs" },
    ],
    soups: [
      { id:"sup-01", names:{ru:"Бикиншурбо",en:"Bikinsurbo"}, price:34,
        ...
        image:"/menubikinsurbo.png", imageAltEn:"Bikinsurbo soup in a bowl" },
      { id:"sup-02", names:{ru:"Хомшурбо",en:"Khomsurbo"}, price:28,
        ...
        image:"/menukhomsurbo.png", imageAltEn:"Khomsurbo soup in a bowl" },
    ],
    meat: [
      { id:"meat-01", names:{ru:"Мясное филе с грибами",en:"Meat Fillet with Mushrooms"}, price:58,
        ...
        image:"/menuMyasnoe-file-s-gribami.png", imageAltEn:"Meat fillet with mushrooms" },
      { id:"meat-02", names:{ru:"Баранина в фольге",en:"Lamb in Foil"}, price:52,
        ...
        image:"/menuBranina-v-folge.png", imageAltEn:"Lamb baked in foil" },
    ],
    fish: [
      { id:"fish-01", names:{ru:"Форель на мангале (1 кг)",en:"Grilled Trout (1 kg)"}, price:195,
        ...
        image:"/menuForel-na-mangale.png", imageAltEn:"Grilled trout (per kg)" },
      { id:"fish-02", names:{ru:"Форель жареный (1 кг)",en:"Fried Trout (1 kg)"}, price:195,
        ...
        image:"/menuForel-zhareniy.png", imageAltEn:"Fried trout (per kg)" },
    ],
    pasta: [
      { id:"pasta-01", names:{ru:"Фетучини с курицей",en:"Fettuccine with Chicken"}, price:45,
        ...
        image:"/menuFetuchi-s-kuritsei.png", imageAltEn:"Fettuccine with chicken" },
      { id:"pasta-02", names:{ru:"Фетучини с форелью",en:"Fettuccine with Trout"}, price:60,
        ...
        image:"/menuFetuchini-s-forelyu.png", imageAltEn:"Fettuccine with trout" },
    ],
    appetizers: [
      { id:"app-01", names:{ru:"Фруктовая нарезка (1 кг)",en:"Fruit Platter (1 kg)"}, price:70,
        ...
        image:"/menuFruktovaya-Narezka.png", imageAltEn:"Fruit platter" },
    ...
    garnish: [
      ...
      { id:"gar-02", names:{ru:"Картофельное пюре",en:"Mashed Potatoes"}, price:14,
        ...
        image:"/menuMashed-potatoes.png", imageAltEn:"Mashed potatoes" },
    ],
    cutlets: [
      { id:"cut-01", names:{ru:"Котлета на мангале с гарниром",en:"Grilled Cutlet with Side"}, price:40,
        ...
        image:"/menuKotleta-na-mangale-s-garnirom.png", imageAltEn:"Grilled cutlet with side" },
      { id:"cut-02", names:{ru:"Котлета по-домашнему с гарниром",en:"Homemade Cutlet with Side"}, price:42,
        ...
        image:"/menuKotleta-po-domashnemu-s-garnirom.png", imageAltEn:"Homemade cutlet with side" },
    ],
    ribs: [
    ...
    special: [
      { id:"spc-01", names:{ru:"Шашлык ассорти стандарт (10 персон)",en:"Standard Shashlik Platter (10 people)"}, price:435,
        ...
        image:"/menuShashlik-assorti.png", imageAltEn:"Standard shashlik platter" },
      { id:"spc-02", names:{ru:"Шашлык ассорти VIP (15 персон)",en:"VIP Shashlik Platter (15 people)"}, price:640,
        ...
        image:"/menuShashlik-assorti.png", imageAltEn:"VIP shashlik platter" },
    ],
    drinks: []
  } as const;
